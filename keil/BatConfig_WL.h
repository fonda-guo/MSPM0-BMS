...
#define  CELL_NUM         (8)
#define  THERMISTOR_NUM   (7)
#define  NOT_USED_PIN_NUM (2)
...
typedef const struct {
  ...
  uint8_t  Sleep_VoltageTime;
  int16_t  Sleep_WakeComparatorCurrent;
	uint8_t  Sleep_HysteresisTime;
	int16_t  Sleep_ChargerVoltageThreshold;
	int16_t  Sleep_ChargerPACK_TOSDelta;
